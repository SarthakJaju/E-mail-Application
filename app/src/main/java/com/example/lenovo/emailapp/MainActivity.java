package com.example.lenovo.emailapp;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        //since putExtra accepts a string array as an argument it is neccessary to have a string array
        //though only one variable is required
